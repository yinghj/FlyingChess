...
COLLEGE) FOR FALL 2014, TO ADD A HOOK FOR HANDLING RIGHT CLICKS TOO.
...
# Version 4.3.DLN 8/5/2014
#     * Added a hook for right clicks.
# Version 4.3 4/25/2014
#     * Fixed Image getPixel to work with Python 3.4, TK 8.6 
#       (tuple type handling)
...
class GraphWin(tk.Canvas):
    ...
    def setMouseRightHandler(self, func):
