...
class Chess:
    ...
    def updatePosition(self, dieNum): 
        ...
        # A chess can move out of the airport when the player gets a 6.    
            ...
            print "\n!!!Violation: you can't move the chess in the airport without rolling a 6.\n!!!You have wasted one move.\n"
...
if __name__ == "__main__":
    chess1 = Chess(1)
    chess2 = Chess(2)
    chess1.updatePosition(6)
    print chess1.getPosition()
    chess1.updatePosition(2)
    print chess1.getPosition()
    chess2.updatePosition(6)
    chess2.updatePosition(6)
    chess2.updatePosition(4)
    print chess2.getPosition()